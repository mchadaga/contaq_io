...
urlpatterns = [
    ...
    path('accounts/logout', allauth.account.views.LogoutView.as_view(), name="logout"),
    path('accounts/password/change', allauth.account.views.PasswordChangeView.as_view(), name="change_password"),
